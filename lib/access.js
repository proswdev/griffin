...
var access = {
  ...
  /*
  spec = {
    field1: { read/write/rdwr: string/acl },
    field2: { read/write/rdwr: string/acl }
  }
    ...
    obj.$extractFor = (function() {
      ...
      return function(req, obj) {
        ...
        for (var field in obj) {
          if (!(__read[field] instanceof Acl) || __read[field].isGrantedTo(req))
            out[field] = obj[field];
        }
        return out;
      }
      ...
      return function(req, updates, obj) {
        ...
        for (var field in updates) {
          if (obj[field] === undefined || obj[field] !== updates[field])
            if (!(__write[field] instanceof Acl) || __write[field].isGrantedTo(req))
